            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript lover 🚀 | Python Developer 🔧
                </p>
              </div>

              {/* CTA Buttons */}
              <div className="flex flex-col items-center sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <div className="flex gap-4 animate__animated animate__fadeInUp animate__delay-2s">
                  {/* GitHub Button */}
                  <a
                    href="https://github.com/Krishna-1899"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-gray-800 to-gray-700 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#333]"
                  >
                  ...
                  {/* LinkedIn Button */}
                  <a
                    href="https://www.linkedin.com/in/krishna-gajara-5b9204238/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative inline-flex items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#0077B5]"
                  >
                    <span className="block w-full bg-gray-900 transition-all duration-300 ">
                      <span className="relative flex items-center justify-center gap-2 text-gray-300 font-medium group-hover:text-white">
